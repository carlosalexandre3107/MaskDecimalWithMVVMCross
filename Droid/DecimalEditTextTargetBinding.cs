...
{
    public class DecimalEditTextTargetBinding
        : MvxConvertingTargetBinding
    {
        protected EditText EditTextControl
            => Target as EditText;
        ...
        {
            if (target == null)
                Console.WriteLine($"[DEBUG] - (Error) EditText is null in {nameof(DecimalEditTextTargetBinding)}");
        }
